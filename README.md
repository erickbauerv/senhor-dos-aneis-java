...
Ex. 3: SimuladorManagement.Mapa com Legolas, Gimli, Orc e Goblim: `| |L| |I| | |O| | |M|`
...
## SimuladorManagement.Simulador

![](https://steamuserimages-a.akamaihd.net/ugc/947345921269591445/82F23ECFC2088F1E803BB1401C735424FFA78418/)

O SimuladorManagement.Simulador recebe um SimuladorManagement.Mapa e possui um único método público:
...
public void deveVencerSociedadeQuandoAragornELegolasBatalharemContraOrcEGoblim()
    ...
    SimuladorManagement.Mapa mapa = new SimuladorManagement.Mapa();
    SimuladorManagement.Simulador simulador = new SimuladorManagement.Simulador(mapa);
